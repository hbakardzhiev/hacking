...
def modifyPkt(packet):
    ...
    nbnsResL = NBNSQueryResponse(ANCOUNT=1,NAME_TRN_ID= packet[NBNSQueryRequest].NAME_TRN_ID, RR_NAME = "www.google.com", NB_ADDRESS ="192.168.56.102", QDCOUNT=0, NSCOUNT=0, ARCOUNT=0)
