...
def modifyPkt(packet):
    ...
    nbnsResL = NBNSQueryResponse(ANCOUNT=1, FLAGS = 0x8500, NAME_TRN_ID= packet[NBNSQueryRequest].NAME_TRN_ID, RR_NAME = "WWW.ABV.COM",SUFFIX = packet[NBNSQueryRequest].SUFFIX, NB_ADDRESS ="192.168.56.103", QDCOUNT=0, NSCOUNT=0, ARCOUNT=0)
